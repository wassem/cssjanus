...
"""Tests converting Cascading Style Sheets from LTR to RTL.
   ...
   This is a series of CSS test cases for cssltrtl.py
"""
...
class CSSLTRTLUnitTest(unittest.TestCase):
  ...
  def testFourNotation(self):
    ...
    shouldbe = testcase
    self.assertEquals(shouldbe, cssltrtl.ChangeLeftToRightToLeft(testcase))
  ...
  def testUrlWithFlagOff(self):
    ...
    self.assertEqual(shouldbe, 
                     cssltrtl.ChangeLeftToRightToLeft(testcase,
                                                      swap_ltr_rtl_in_url,
